...
modelB = cv2.imread('markers/modelA_p.jpg', 0)
modelA = cv2.imread('markers/modelB_p.jpg', 0)
...
if var == 0:
	out = cv2.VideoWriter('exampels/var_animation.mp4', fourcc, fps, (width,height))
else:
	out = cv2.VideoWriter('exampels/animation.mp4', fourcc, fps, (width,height))
